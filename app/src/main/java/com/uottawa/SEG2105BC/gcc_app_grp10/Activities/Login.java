...
public class Login extends AppCompatActivity implements CanReceiveAUser {
    ...
    public void OnLoginButton(View view) {
        ...
        authenticationHandler.signIn(this,email.getEditText().getText().toString().trim(),password.getEditText().getText().toString().trim(),role,this,this);
    }
